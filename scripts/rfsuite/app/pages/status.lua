...
if rfsuite.config.ethosRunningVersion >= 1516 then
        ...
        displayPos = {x = x - buttonW - buttonWs - 5 - buttonWs, y = rfsuite.app.radio.linePaddingTop, w = 100, h = rfsuite.app.radio.navbuttonHeight}
end 
                        ...
                        if rfsuite.bg.msp.mspQueue:isProcessed() then
                                ...
                                if rfsuite.config.ethosRunningVersion < 1516 then
                                   if status.armingDisableFlags ~= nil then
                                                ...
                                                rfsuite.app.formFields[1] = form.addTextField(rfsuite.app.formLines[1], nil, function()
                                                        return value
                                                end, function(newValue)
                                                        text = value
                                                end)
                                                rfsuite.app.formFields[1]:enable(false)
                                        end

                                        if summary.supported == true then
                                                local value = getFreeDataflashSpace()
                                                rfsuite.app.formFields[2] = form.addTextField(rfsuite.app.formLines[2], nil, function()
                                                        return value
                                                end, function(newValue)
                                                        text = value
                                                end)
                                        ...
                                        if status.realTimeLoad ~= nil then
                                                ...
                                                rfsuite.app.formFields[3] = form.addNumberField(rfsuite.app.formLines[3], nil, value, value, function()
                                                        return value
                                                end, function(value)
                                                end)
                                                rfsuite.app.formFields[3]:suffix("%")
                                                rfsuite.app.formFields[3]:decimals(1)
                                                rfsuite.app.formFields[3]:enable(false)
                                        end
                                        if status.cpuLoad ~= nil then
                                                local value = status.cpuLoad
                                                rfsuite.app.formFields[4] = form.addNumberField(rfsuite.app.formLines[4], nil, value, value, function()
                                                        return value
                                                end, function(value)
                                                end)
                                                rfsuite.app.formFields[4]:suffix("%")
                                                rfsuite.app.formFields[4]:decimals(1)
