...
local function openPage(pidx, title, script)
        ...
        for pidx, pvalue in ipairs(ESC.pages) do
                ...
                if rfsuite.config.iconsizeParam ~= 0 then
                        if rfsuite.app.gfx_buttons["esctool"][pvalue.image] == nil then rfsuite.app.gfx_buttons["esctool"][pvalue.image] = lcd.loadMask(rfsuite.config.suiteDir .. "app/gfx/esc/" .. pvalue.image) end
                else
