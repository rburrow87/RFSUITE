...
function ui.openMainMenu()
        ...
        -- size of buttons
        config.iconsizeParam = rfsuite.app.preferences.interface.iconSize
        ...
        for idx, value in ipairs(MainMenu.sections) do
                ...
                for pidx, pvalue in ipairs(MainMenu.pages) do
                        if pvalue.section == value.section then
                                ...
                                if lc == 0 then
                                        if config.iconsizeParam == 0 then y = form.height() + rfsuite.app.radio.buttonPaddingSmall end
                                        if config.iconsizeParam == 1 then y = form.height() + rfsuite.app.radio.buttonPaddingSmall end
                                        if config.iconsizeParam == 2 then y = form.height() + rfsuite.app.radio.buttonPadding end
                                end
